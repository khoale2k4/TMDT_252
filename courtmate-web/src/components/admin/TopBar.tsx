    ...
    <header className="h-16 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-6 shrink-0 sticky top-0 z-10">
      ...
      <div className="flex-1 max-w-md">
        <div className="relative">
          ...
          <input 
            type="text" 
            placeholder="Search bookings, courts, customers..." 
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3 cursor-pointer group">
          <div className="flex flex-col items-end hidden sm:flex">
            <span className="text-sm font-semibold text-slate-900 dark:text-slate-100 leading-none">Admin User</span>
            <span className="text-xs text-slate-500 dark:text-slate-400 mt-1 leading-none">Owner</span>
          </div>
