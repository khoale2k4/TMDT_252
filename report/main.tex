...
%%%%%%%%%%%%%%%%%INTRO%%%%%%%%%%%%%%%%%%%
\input{Intro/MemberContribution}
\newpage
\tableofcontents
\newpage
\listoffigures
...
\input{Contents/Part1_Overview.tex}
\newpage
\input{Contents/Part2_BusinessModel.tex}
\newpage
\input{Contents/Part3A_SalesStrategy.tex}
\newpage
\input{Contents/Part3B_Marketing.tex}
\newpage
\input{Contents/Part3C_FinanceHR.tex}
\newpage
\input{Contents/Part4_Technical.tex}
\newpage
\input{Contents/Part5_Implementation.tex}
\newpage
