...
\begin{itemize}
    \item \textit{Localized Integration:} Tích hợp sâu với các cổng thanh toán MoMo, ZaloPay và đặc biệt là hệ thống hóa đơn điện tử MISA. Đây là rào cản kỹ thuật mà các ứng dụng quốc tế khó vượt qua tại thị trường Việt Nam.
...
\begin{table}[H]
    ...
    Bản địa hóa & Tối ưu (MISA/MoMo) & Hạn chế \cite{ref:playtomic, ref:courtreserve} & Tốt (Thanh toán VN) & Thủ công \\ \hline
